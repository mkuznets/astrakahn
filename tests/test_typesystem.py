...
class TestTypeSystem(unittest.TestCase):
    ...
    def test_elementary(self):
        ...
        out_float = cast_message(float, rfloat)
        self.assertEqual(out_float, rfloat)

        out_int = cast_message(int, rint)
    ...
    def test_typle(self):
        ...
        self.assertEqual(cast_message(rint_tuple_pass_ok, rint_tuple),
                         rint_tuple)
        self.assertEqual(cast_message(rfloat_tuple_pass_ok, rfloat_tuple),
                         rfloat_tuple)
    ...
    def test_list(self):
        ...
        self.assertEqual(cast_message(rint_list_pass_ok_1, rint_list),
                         rint_list)
        self.assertEqual(cast_message(rfloat_list_pass_ok_1, rfloat_list),
                         rfloat_list)
        self.assertEqual(cast_message(rint_list_pass_ok_2, rint_list),
                         rint_list[:-3])
        self.assertEqual(cast_message(rfloat_list_pass_ok_2, rfloat_list),
                         rfloat_list[:-3])
        self.assertEqual(cast_message(rint_list_pass_ok_3, rint_list),
                         rint_list[:-5] + [rint_list[-5:]])
        self.assertEqual(cast_message(rfloat_list_pass_ok_3, rfloat_list),
